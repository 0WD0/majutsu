...
(ert-deftest majutsu-gerrit-account-candidate-data/uses-account-query-with-details ()
  "Account completion should query accounts with DETAILS so fields match suggest."
  (let (seen)
