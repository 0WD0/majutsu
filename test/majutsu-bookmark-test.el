...
(ert-deftest majutsu-bookmark-list-template/uses-typed-commitref-fields ()
  ...
  (should-not (string-match-p "format_commit_summary_with_refs" majutsu-bookmark--list-template))
  ...
  (should (string-match-p (regexp-quote "change_id().shortest(8)")
                          majutsu-bookmark--list-template))
  (should (string-match-p (regexp-quote "commit_id().shortest(8)")
                          majutsu-bookmark--list-template))
  (should (string-match-p (regexp-quote "description().first_line()")
                          majutsu-bookmark--list-template))
