...
- Thing-at-point: Add a dedicated JJ revision target layer so revset readers
  and commands such as ~majutsu-edit-changeset~ and ~majutsu-new-dwim~ prefer
  the literal revision/ref under point, while bookmark/tag readers now default
  to exact refs at point before falling back to contextual revision data.
