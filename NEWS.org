...
- Arrange: Add initial ~majutsu-arrange-mode~ for editing =jj arrange=-style
  graph rewrite plans with target/context loading, repeated =REVSETS= input,
  keep/abandon marking, graph-neighbor swaps, DAG-preserving marked/subdag
  moves, and a conservative CLI replay backend.
