...
- Jujutsu 0.41.0 or later is now required ::
  The Gerrit upload transient exposes =--message=, =--edit=, and =--merged=,
  and the template registry includes =replace()= require jj 0.41.0.
...
- Semantic copy for structured row buffers ::
  Log, evolution-log, and operation-log buffers share one copy submenu.
