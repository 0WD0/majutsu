...
- jj diff-editor sessions with optional Ghostel terminal hosting ::
  ...
  Ghostel when available; local sessions need =emacsclient= support, while
  Ghostel-supported TRAMP remotes use with-editor's sleeping-editor bridge.
...
- Patch selections now survive cancelled editor sessions ::
  ...
  operation, and clears position-based selections before a confirmed refresh.
