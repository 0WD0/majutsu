...
- Command: majutsu-op-show :: Show metadata, description/tags, and sectionized repository changes for one operation.
  Sections are expanded by default. Changed commit and ref target lines keep full commit/change IDs internally; press =RET= or =d= on a line to open its ordinary commit diff.
