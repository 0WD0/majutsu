...
** Arranging History
- Key: h in the dispatcher (majutsu-arrange) :: Open an Emacs-native arrange buffer for editing a =jj arrange=-style graph rewrite plan. With a prefix argument, prompt for one or more =REVSETS=, matching =jj arrange [REVSETS]...= by arranging their union.
