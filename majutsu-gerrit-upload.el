...
;; option readers.  It is separated from `majutsu-gerrit.el' so that
;; `majutsu-gerrit.el' can act as a top-level dispatcher without
;; creating circular dependencies with the dashboard module.
