...
;; Silence byte-compiler warnings for internal Magit helpers we intentionally use.
(declare-function magit-section-equal "magit-section" (a b))
(declare-function magit-section-goto-successor--same "magit-section" (section line char))
