...
The format is based on [[https://keepachangelog.com/en/1.1.0/][Keep a Changelog 1.1.0]] and this project adheres to [[https://semver.org/spec/v2.0.0.html][Semantic Versioning 2.0.0]].
